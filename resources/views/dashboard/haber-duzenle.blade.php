...
<form class="outer-repeater"  method="post" action="{{route('haberupdate',['id'=>$haber->id])}}" enctype="multipart/form-data">
    @csrf
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                    ...
                    <div data-repeater-list="outer-group" class="outer">
                        <div data-repeater-item class="outer">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-lg-10">
                                    <input id="taskname" name="haber_title" type="text" value="{{$haber->haber_title}}" class="form-control" placeholder="Haber Başlığı">
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                <label for="taskname" class="col-form-label col-lg-2">Haber İçeriği</label>
                                <div class="col-lg-10">
                                    <textarea id="taskname" name="haber_content" type="text" class="form-control">{{$haber->haber_content}}</textarea>
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                <label for="taskname" class="col-form-label col-lg-2">Haber Kategorisi</label>
                                <div class="col-lg-10">
                                    <input id="taskname" name="haber_kategori" type="text" value="{{$haber->haber_kategori}}" class="form-control" placeholder="Haber Kategorisi">
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                <label for="taskname" class="col-form-label col-lg-2">Haber Yazarı</label>
                                <div class="col-lg-10">
                                    <input id="taskname" name="haber_yetkili" type="text" value="{{$haber->haber_yetkili}}" class="form-control" placeholder="Haber Yazarı">
                                </div>
                            </div>
