...
@slot('title') Menü Ekle @endslot
@endcomponent

@if(session('menuSuccess'))
    <div class="alert alert-success">{{session('menuSuccess')}}
    </div>
@endif
<form class="outer-repeater"  method="post" action="{{route('menueklesave')}}" enctype="multipart/form-data" autocomplete="off">
    @csrf
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-lg-10">
                                    ...
                                    <option value="0">Seçiniz</option>
                                            @if(\PHPUnit\Framework\isEmpty($ustmenu))
                                                    @foreach($ustmenu as $ustm)
                                                    <option value="{{$ustm->id}}" >{{$ustm->menu_title}}</option>
                                                @endforeach
                                            @endif
                                    </select>
                                </div>
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-lg-10">
                            ...
                            <div id="cat_div" class="form-group row mb-2 mt-4" style="{{ ($newmenu->menu_link_type ==0)? "":"display: none" }}">
                                ...
                                <div class="col-lg-12">
                                    <input id="menulink" name="menu_link" type="text" value="{{$newmenu->menu_link}}"  class="form-control" placeholder="Menü Link">
                                </div>
                            </div>
                                ...
                                <div class="col-lg-12">
                                    <select class="form-select" name="menu_page_id">
                                        ...
                                        @foreach($selectpages as $selectpage)
                                            <option value='{{$selectpage->id}}'>{{$selectpage->title}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
