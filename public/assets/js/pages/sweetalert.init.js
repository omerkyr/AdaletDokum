...
var _require2 = __webpack_require__(/*! ../../../public/assets/libs/sweetalert2/sweetalert2.min */ "./public/assets/libs/sweetalert2/sweetalert2.min.js"),
    ...
    // document.getElementById("sa-warning").addEventListener("click", function() {
        ...
        Swal.fire({
            title: "'" + $title + "'" + ' menüsünü silmek istediğinize emin misiniz ? ',
            text: "Bu işlemi geri alamazsınız!",
            icon: "error",
            showCancelButton: true,
            confirmButtonColor: "#13743a",
            cancelButtonColor: "#fd625e",
            confirmButtonText: "Evet, Sil!",
            cancelButtonText: 'Hayır, Geri Dön'
        }).then(function (result) {
            if (result.value) {
                // Swal.fire("Silindi!", "Menü başarıyla silindi.", "success");
                window.location.href = '/admin/menusil/' + $dataid;
            }
        });
    });

    $(document).on('click', '#sa-page', function(e) {
    // document.getElementById("sa-warning").addEventListener("click", function() {
        let $dataid = $(this).data('dataid');
        let $title = $(this).data('title');
        Swal.fire({
            title: "'" + $title + "'" + ' sayfasını silmek istediğinize emin misiniz ? ',
            text: "Bu işlemi geri alamazsınız!",
            icon: "error",
            showCancelButton: true,
            confirmButtonColor: "#13743a",
            ...
            if (result.value) {
                // Swal.fire("Silindi!", "Menü başarıyla silindi.", "success");
                window.location.href = '/admin/sayfasil/' + $dataid;
            }
        });
    });

    $(document).on('click', '#sa-pagefiledelete', function(e) {
        // document.getElementById("sa-warning").addEventListener("click", function() {
        let $dataid = $(this).data('dataid');
        let $title = $(this).data('title');
        Swal.fire({
            title: "'" + $title + "'" + ' dosyasını silmek istediğinize emin misiniz ? ',
            text: "Bu işlemi geri alamazsınız!",
            icon: "error",
            showCancelButton: true,
            confirmButtonColor: "#13743a",
            ...
            if (result.value) {
                // Swal.fire("Silindi!", "Menü başarıyla silindi.", "success");
                window.location.href = '/admin/sayfa-dosya-sil/' + $dataid;
            }
        });
    });

    $(document).on('click', '#sa-kategorisil', function(e) {
        // document.getElementById("sa-warning").addEventListener("click", function() {
        let $dataid = $(this).data('dataid');
        let $title = $(this).data('title');
        Swal.fire({
            title: "'" + $title + "'" + ' kategorisini silmek istediğinize emin misiniz ? ',
            text: "Bu işlemi geri alamazsınız!",
            icon: "error",
            showCancelButton: true,
            confirmButtonColor: "#13743a",
            ...
            if (result.value) {
                // Swal.fire("Silindi!", "Menü başarıyla silindi.", "success");
                window.location.href = '/admin/kategori-sil/' + $dataid;
            }
        });
    });

    $(document).on('click', '#sa-slidersil', function(e) {
        // document.getElementById("sa-warning").addEventListener("click", function() {
        let $dataid = $(this).data('dataid');
        let $title = $(this).data('title');
        Swal.fire({
            title: "'" + $title + "'" + ' sliderı silmek istediğinize emin misiniz ? ',
            text: "Bu işlemi geri alamazsınız!",
            icon: "error",
            showCancelButton: true,
            confirmButtonColor: "#13743a",
            ...
            if (result.value) {
                // Swal.fire("Silindi!", "Menü başarıyla silindi.", "success");
                window.location.href = '/admin/slider-sil/' + $dataid;
            }
        });
    });

    const btn = document.getElementById('sa-imageSlideDelete');
...
// ✅ Using optional chaining (?.)
    btn?.addEventListener('click', () => {
        let $dataid = $(this).data('dataid');
            let $title = $(this).data('title');
            Swal.fire({
                title: "'" + $title + "'" + ' resmi silicenek emin misin ? ',
                text: "Bu işlemi geri alamazsınız!",
                icon: "error",
                showCancelButton: true,
                confirmButtonColor: "#13743a",
                ...
                if (result.value) {
                    // Swal.fire("Silindi!", "Menü başarıyla silindi.", "success");
                    window.location.href = 'destroy/' + $dataid;
                }
            });
    });


    // $(document).on('click', '#sa-imageSlideDelete', function(e) {
    //     // document.getElementById("sa-warning").addEventListener("click", function() {
    //     let $dataid = $(this).data('dataid');
    //     let $title = $(this).data('title');
    //     Swal.fire({
