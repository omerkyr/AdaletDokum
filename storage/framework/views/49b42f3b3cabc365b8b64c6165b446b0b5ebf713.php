<?php $__env->startSection('title'); ?> <?php echo e($kategori->kategori_title); ?>  <?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
<?php $__env->startComponent('components.breadcrumb'); ?>
<?php $__env->slot('li_1'); ?> Kategori Düzenle <?php $__env->endSlot(); ?>
<?php $__env->slot('title'); ?> <?php echo e($kategori->kategori_title); ?> <?php $__env->endSlot(); ?>
<?php echo $__env->renderComponent(); ?>

<?php if(session('KategoriEkleSuccess')): ?>
    <div class="alert alert-success"><?php echo e(session('KategoriEkleSuccess')); ?>

    </div>
<?php endif; ?>


<form class="outer-repeater"  method="post" action="<?php echo e(route('kategoriupdate',['id'=>$kategori->id])); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                    ...
                    <div data-repeater-list="outer-group" class="outer">
                        <div data-repeater-item class="outer">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-lg-10">
                                    <input id="taskname" name="kategori_title" type="text" value="<?php echo e($kategori->kategori_title); ?>" class="form-control" placeholder="Kategori Başlığı">
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                <label for="taskname" class="col-form-label col-lg-2">Kategori Açıklaması</label>
                                <div class="col-lg-10">
                                    <textarea id="ckeditor-classic" name="kategori_aciklama" type="text" class="form-control"><?php echo e($kategori->kategori_aciklama); ?></textarea>
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                <label for="kategori_link" class="col-form-label col-lg-2">Kategori Link</label>
                                <div class="col-lg-10">
                                    <input id="kategori_link" name="kategori_link" type="text" value="<?php echo e($kategori->kategori_link); ?>" class="form-control" placeholder="Haber Kategorisi">
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-lg-10">
                                    ...
                                    <div class="col-lg-12" id="bannerhide"  <?php echo ($kategori->kategori_banner_status == 0) ? "style='display:none'":""; ?>>
                                        ...
                                        <img style="max-width: 600px;" src="<?php echo e(asset('/fronted/')); ?>/images/banner/<?php echo e($kategori->kategori_banner); ?>">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div data-repeater-list="outer-group" class="outer">
                        <div data-repeater-item class="outer">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-lg-10">
                                    <input id="i-seotitle" name="seo_title" value="<?php echo e($kategori->seo_title); ?>" type="text" class="form-control" placeholder="">
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                <label for="i-seodescription" class="col-form-label col-lg-2">Seo Açıklaması</label>
                                <div class="col-lg-10">
                                    <input id="i-seodescription" name="seo_description" value="<?php echo e($kategori->seo_description); ?>" type="text" class="form-control" placeholder="">
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                <label for="i-seokeywords" class="col-form-label col-lg-2">Seo Anahtarı</label>
                                <div class="col-lg-10">
                                    <input id="i-seokeywords" name="seo_keywords" value="<?php echo e($kategori->seo_keywords); ?>" type="text" class="form-control" placeholder="">
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                <label for="i-seourlslug" class="col-form-label col-lg-2">Seo Url Slug</label>
                                <div class="col-lg-10">
                                    <input id="i-seourlslug" name="seo_url_slug" value="<?php echo e($kategori->seo_url_slug); ?>" type="text" class="form-control" placeholder="">
                                </div>
                            </div>
                            <div class="row justify-content-end">
                                <div class="col-lg-10">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\adaletdokum\resources\views/dashboard/kategori-duzenle.blade.php ENDPATH**/ ?>