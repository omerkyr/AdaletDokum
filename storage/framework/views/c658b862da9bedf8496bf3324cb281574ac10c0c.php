								...
								<div class="pull-left">
									<div class="phone-box">
										<div class="box-inner">
											...
											İletişim Numaramız
											<strong><?php echo e($ayar->contact_tel); ?></strong>
										</div>
									</div>
								</div>
							</div>
...
<?php echo $__env->make('fronted.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\adaletdokum\resources\views/fronted/index.blade.php ENDPATH**/ ?>