                    ...
                    <div class="w-100">
                        <div class="d-flex flex-column h-100">
                            <div class="mb-4 mb-md-5 text-center">
                                <a href="<?php echo e(url('www.qryazilim.com')); ?>" class="d-block auth-logo">
                                    <img src="<?php echo e(URL::asset('images/qryazilim.png')); ?>" alt="qryazilim" height="32">
                                </a>
                            </div>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('email', 'kyrspor.99@gmail.com')); ?>" id="input-username" placeholder="Enter User Name" name="email">
...
unset($__errorArgs, $__bag); ?>" name="password" id="password-input" placeholder="Şifreyi Griniz">
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\adaletdokum\resources\views/auth/login.blade.php ENDPATH**/ ?>